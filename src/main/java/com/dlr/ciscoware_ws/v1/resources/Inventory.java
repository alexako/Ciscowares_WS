...
@NamedQueries({
    ...
    , @NamedQuery(name = "Inventory.findByBranchId", query = "SELECT i FROM Inventory i WHERE i.branchId = :branchId")})
public class Inventory implements Serializable {
    ...
    public Inventory(Integer id, int quantity, int branchId) {
        this.id = id;
    ...
    public String toString() {
        return "com.dlr.ciscoware_ws.v1.resources.Inventory[ id=" + id + " ]";
    }
